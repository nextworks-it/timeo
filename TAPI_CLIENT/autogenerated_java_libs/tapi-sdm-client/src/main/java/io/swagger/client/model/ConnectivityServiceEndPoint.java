...
//  public void setServiceInterfacePoint(ServiceInterfacePointRef serviceInterfacePoint) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(localId, name, administrativeState, lifecycleState, operationalState, direction, capacity, protectionRole, layerProtocolName, role, serviceInterfacePoint);
  }
