...
public class DefaultApiTest {
	...
	public void createCreateConnectivityServiceByIdTest() throws ApiException {
		api.setApiClient(new ApiClient()
					.setConnectTimeout(0)
					.setBasePath("http://10.0.50.10:8182/restconf")
					.setDebugging(true));
	...
	public void retrieveConnectivityRequestFromFile() {
		...
		//Gson gson =  new Gson();
		InputStream in = DefaultApiTest.class.getResourceAsStream("/create-connectivity.json");
		Reader reader  = null;
		try {
			reader = new InputStreamReader(in, "UTF-8");
			CreateConnectivityServiceRPCInputSchema createConnectivityService = gson.fromJson(reader, CreateConnectivityServiceRPCInputSchema.class);
			String  result = gson.toJson(createConnectivityService);
	...
	private CreateConnectivityServiceRPCInputSchema getRequestFromFile(String file) throws UnsupportedEncodingException {
		InputStream in = DefaultApiTest.class.getResourceAsStream(file);
		Reader reader  = null;
		reader = new InputStreamReader(in, "UTF-8");
		GsonBuilder gsonBuilder = new GsonBuilder();
		gsonBuilder.setPrettyPrinting();
		...
		Gson gson = gsonBuilder.create();
		CreateConnectivityServiceRPCInputSchema req = gson.fromJson(reader, CreateConnectivityServiceRPCInputSchema.class);
		return req;

	}

	@Test
	public void simulateObfnScenario() {
		api.setApiClient(new ApiClient()
				.setConnectTimeout(0)
				.setReadTimeout(0)
				.setWriteTimeout(0)
		...
		try {
			...
			CreateConnectivityServiceRPCInputSchema reqStep1 = this.getRequestFromFile("/create-step-1.json");
			CreateConnectivityServiceRPCInputSchema reqStep2 =this.getRequestFromFile("/create-step-2.json");
			CreateConnectivityServiceRPCInputSchema reqStep3 =this.getRequestFromFile("/create-step-3.json");
			CreateConnectivityServiceRPCInputSchema reqStep4 =this.getRequestFromFile("/create-step-4.json");

			CreateConnectivityServiceRPCInputSchema responseStep1 = api.createCreateConnectivityServiceById(reqStep1);

			System.out.println(gson.toJson(responseStep1.getUuid()));
			CreateConnectivityServiceRPCInputSchema responseStep2 = api.createCreateConnectivityServiceById(reqStep2);
			System.out.println(gson.toJson(responseStep2.getUuid()));
			CreateConnectivityServiceRPCInputSchema responseStep3 = api.updateCreateConnectivityServiceById(reqStep3);
			System.out.println(gson.toJson(responseStep3.getUuid()));
			CreateConnectivityServiceRPCInputSchema responseStep4 = api.updateCreateConnectivityServiceById(reqStep4);
			System.out.println(gson.toJson(responseStep4.getUuid()));


			//STEP5
			reqStep1.getObfnConnectivityConstraintSpec().getObfnPool().get(0).beamEnable(false);
			CreateConnectivityServiceRPCInputSchema responseStep5 = api.updateCreateConnectivityServiceById(reqStep1);
			System.out.println(gson.toJson(responseStep5.getUuid()));


			//STEP6
			reqStep2.getObfnConnectivityConstraintSpec().getObfnPool().get(0).beamEnable(false);
			CreateConnectivityServiceRPCInputSchema responseStep6 = api.updateCreateConnectivityServiceById(reqStep2);
			System.out.println(gson.toJson(responseStep6.getUuid()));

			//STEP7
			api.createDeleteConnectivityServiceById(reqStep1.getUuid());
			//STEP8
			api.createDeleteConnectivityServiceById(reqStep2.getUuid());
	...
	public void createDeleteConnectivityServiceByIdTest() throws ApiException {
		api.setApiClient(new ApiClient()
				...
				.setDebugging(true));
		try {
			api.createDeleteConnectivityServiceById("8b708116-9135-11ea-bb37-0242ac130002");
		}catch(Exception e) {
			//TODO: manage error
	...
	@Test
	@Ignore
	public void parseObfnContext() throws ApiException {
		...
		try {
			...
			ContextSchema response= gson.fromJson(reader, ContextSchema.class);
			System.out.println(response.getServiceInterfacePoint().get(0));
