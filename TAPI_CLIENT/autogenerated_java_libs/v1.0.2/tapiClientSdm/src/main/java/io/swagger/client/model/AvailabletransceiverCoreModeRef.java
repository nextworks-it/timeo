...
public class AvailabletransceiverCoreModeRef {
  ...
  public AvailabletransceiverCoreModeRef modeId(List<AvailabletransceiverModeid> modeId) {
    this.modeId = modeId;
    return this;
  }

  public AvailabletransceiverCoreModeRef addModeIdItem(AvailabletransceiverModeid modeIdItem) {
    if (this.modeId == null) {
  ...
  **/
  ...
  public AvailabletransceiverCoreModeRef coreModeRef(String coreModeRef) {
  ...
  **/
  ...
  public AvailabletransceiverCoreModeRef coreId(List<AvailabletransceiverCoreid> coreId) {
    this.coreId = coreId;
    return this;
  }

  public AvailabletransceiverCoreModeRef addCoreIdItem(AvailabletransceiverCoreid coreIdItem) {
    if (this.coreId == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AvailabletransceiverCoreModeRef availabletransceiverCoreModeRef = (AvailabletransceiverCoreModeRef) o;
    return Objects.equals(this.modeId, availabletransceiverCoreModeRef.modeId) &&
        Objects.equals(this.coreModeRef, availabletransceiverCoreModeRef.coreModeRef) &&
        Objects.equals(this.coreId, availabletransceiverCoreModeRef.coreId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AvailabletransceiverCoreModeRef {\n");
