...
public class RiskParameterPac   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "A list of risk characteristics for consideration in an analysis of shared risk. Each element of the list represents a specific risk consideration.")
