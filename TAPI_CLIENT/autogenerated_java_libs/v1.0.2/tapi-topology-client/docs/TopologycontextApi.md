...
# **retrieveContextTopologyContextTopologyNodeOwnedNodeEdgePointOwnedNodeEdgePointById**
> NodeEdgePoint retrieveContextTopologyContextTopologyNodeOwnedNodeEdgePointOwnedNodeEdgePointById(uuid, nodeUuid, ownedNodeEdgePointUuid)
...
String ownedNodeEdgePointUuid = "ownedNodeEdgePointUuid_example"; // String | ID of owned_node_edge_point_uuid
try {
    NodeEdgePoint result = apiInstance.retrieveContextTopologyContextTopologyNodeOwnedNodeEdgePointOwnedNodeEdgePointById(uuid, nodeUuid, ownedNodeEdgePointUuid);
    System.out.println(result);
} catch (ApiException e) {
