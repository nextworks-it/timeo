...
public class ResilienceConstraint   {
  ...
  private List<PreferredRestorationLayerEnum> preferredRestorationLayer = new ArrayList<PreferredRestorationLayerEnum>();

  /**
   * Indcates whether the protection scheme is revertive or non-revertive.
   */
  public enum ReversionModeEnum {
    @SerializedName("REVERTIVE")
    REVERTIVE("REVERTIVE"),
    
    @SerializedName("NON-REVERTIVE")
  ...
  public enum RestorationCoordinateTypeEnum {
    @SerializedName("NO_COORDINATE")
    NO_COORDINATE("NO_COORDINATE"),
    
    @SerializedName("HOLD_OFF_TIME")
    HOLD_OFF_TIME("HOLD_OFF_TIME"),
    
    @SerializedName("WAIT_FOR_NOTIFICATION")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Used to limit the maximum swtich times. When work fault disappears , and traffic return to the original work path, switch counter reset.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "If the protection system is revertive, this attribute specifies the time, in minutes, to wait after a fault clears on a higher priority (preferred) resource before reverting to the preferred resource.")
  ...
  **/
   ...
   * @return isLockOut
  **/
  @ApiModelProperty(example = "null", value = "The resource is configured to temporarily not be available for use in the protection scheme(s) it is part of. This overrides all other protection control states including forced. If the item is locked out then it cannot be used under any circumstances. Note: Only relevant when part of a protection scheme.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Is operating such that switching at both ends of each flow acorss the FC is coordinated at both ingress and egress ends.")
   ...
   * @return isFrozen
  **/
  @ApiModelProperty(example = "null", value = "Temporarily prevents any switch action to be taken and, as such, freezes the current state. Until the freeze is cleared, additional near-end external commands are rejected and fault condition changes and received APS messages are ignored. All administrative controls of any aspect of protection are rejected.")
  ...
  public ResilienceConstraint preferredRestorationLayer(List<PreferredRestorationLayerEnum> preferredRestorationLayer) {
    this.preferredRestorationLayer = preferredRestorationLayer;
    return this;
  }

  public ResilienceConstraint addPreferredRestorationLayerItem(PreferredRestorationLayerEnum preferredRestorationLayerItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Indcates whether the protection scheme is revertive or non-revertive.")
   ...
   * @return holdOffTime
  **/
  @ApiModelProperty(example = "null", value = "This attribute indicates the time, in milliseconds, between declaration of signal degrade or signal fail, and the initialization of the protection switching algorithm.")
  ...
  **/
  @ApiModelProperty(example = "null", value = " The coordination mechanism between multi-layers.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.maxSwitchTimes, resilienceConstraint.maxSwitchTimes) &&
        ...
        Objects.equals(this.preferredRestorationLayer, resilienceConstraint.preferredRestorationLayer) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maxSwitchTimes, waitToRevertTime, restorePriority, isLockOut, isCoordinatedSwitchingBothEnds, isFrozen, preferredRestorationLayer, reversionMode, holdOffTime, resilienceType, restorationCoordinateType);
  }
