...
public class TransferIntegrityPac   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Describes the degree to which the signal propagated can be errored. Applies to TDM systems as the errored signal will be propagated and not packet as errored packets will be discarded.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Describes the duration for which there may be no valid signal propagated.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Describes the degree to which packets will be delivered out of sequence. Does not apply to TDM as the TDM protocols maintain strict order.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Describes the effect of any server integrity enhancement process on the characteristics of the TopologicalEntity.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Primarily applies to packet systems where a packet may be delivered more than once (in fault recovery for example). It can also apply to TDM where several frames may be received twice due to switching in a system with a large differential propagation delay.")
