...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-19T14:05:07.585+02:00[Europe/Rome]")public class DashboardPanel {
  ...
  * @return query
  **/
  @Schema(description = "the query whose value the graph in the panel should show. See https://prometheus.io/docs/prometheus/latest/querying/basics/ for details ")
  ...
  * @return size
  **/
  @Schema(description = "the size of the panel")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(title, query, size);
  }
