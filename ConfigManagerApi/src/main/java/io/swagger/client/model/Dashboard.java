...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-19T14:05:07.585+02:00[Europe/Rome]")public class Dashboard {
  ...
  * @return dashboardId
  **/
  @Schema(description = "the ID assigned to the dashboard")
  ...
  * @return url
  **/
  @Schema(description = "the URL through which the dashboard is reachable")
  ...
  * @return panels
  **/
  @Schema(description = "the panels to be included in the dashboard")
  ...
  * @return users
  **/
  @Schema(description = "the users which should be allowed to see this dashboard")
  ...
  * @return plottedTime
  **/
  @Schema(description = "the time interval to be shown on the graphs, in minutes")
  ...
  * @return refreshTime
  **/
  @Schema(description = "the time interval to wait before refreshing the graphs")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(dashboardId, url, name, panels, users, plottedTime, refreshTime);
  }
