...
public class ExporterApi {
     ...
     */
    public Object deleteExporter(String exporterId) throws ApiException {
        ApiResponse<Object> resp = deleteExporterWithHttpInfo(exporterId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> deleteExporterWithHttpInfo(String exporterId) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call deleteExporterAsync(String exporterId, final ApiCallback<Object> callback) throws ApiException {
     ...
     * @param body The exporter to be created (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postExporterCall(ExporterDescription body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postExporterValidateBeforeCall(ExporterDescription body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postExporter(Async)");
        }
        
        com.squareup.okhttp.Call call = postExporterCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Exporter postExporter(ExporterDescription body) throws ApiException {
        ApiResponse<Exporter> resp = postExporterWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Exporter> postExporterWithHttpInfo(ExporterDescription body) throws ApiException {
        com.squareup.okhttp.Call call = postExporterValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<Exporter>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postExporterAsync(ExporterDescription body, final ApiCallback<Exporter> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postExporterValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Exporter>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param body The exporter data to update (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call putExporterCall(Exporter body, String exporterId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call putExporterValidateBeforeCall(Exporter body, String exporterId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling putExporter(Async)");
        }
        // verify the required parameter 'exporterId' is set
        if (exporterId == null) {
        ...
        com.squareup.okhttp.Call call = putExporterCall(body, exporterId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Exporter putExporter(Exporter body, String exporterId) throws ApiException {
        ApiResponse<Exporter> resp = putExporterWithHttpInfo(body, exporterId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Exporter> putExporterWithHttpInfo(Exporter body, String exporterId) throws ApiException {
        com.squareup.okhttp.Call call = putExporterValidateBeforeCall(body, exporterId, null, null);
        Type localVarReturnType = new TypeToken<Exporter>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putExporterAsync(Exporter body, String exporterId, final ApiCallback<Exporter> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = putExporterValidateBeforeCall(body, exporterId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Exporter>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
