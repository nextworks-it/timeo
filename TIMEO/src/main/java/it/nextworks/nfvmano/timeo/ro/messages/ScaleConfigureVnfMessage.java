...
public class ScaleConfigureVnfMessage extends AllocationMessage {
	...
	@JsonCreator
	public ScaleConfigureVnfMessage(@JsonProperty("nsInstanceId") String nsInstanceId,
			@JsonProperty("operationId") String operationId,
			@JsonProperty("request") ScaleNsRequest request) {
		this.type = AllocationMessageType.SCALE_CONFIGURE_VNF;
