...
public class CdnStaticAlgorithm5tonic extends AbstractNsResourceAllocationAlgorithm {
	...
	public NsResourceSchedulingSolution computeNsResourceAllocationSolution(InstantiateNsRequest request, Nsd nsd, Map<Vnfd, Map<String, String>> vnfds, 
		...
		nph1.add(new NetworkPathHop(0, "openflow:2", "openflow:2:1", "openflow:2:4", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph1.add(new NetworkPathHop(1, "openflow:9", "openflow:9:3", "openflow:9:4", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		...
		if (request.getNsInstantiationLevelId().equals("il_vCDN_big")) {
			...
			nph2.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:3", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		...
		nph3.add(new NetworkPathHop(0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph3.add(new NetworkPathHop(1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph3.add(new NetworkPathHop(2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph4.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph4.add(new NetworkPathHop(1, "openflow:7", "openflow:7:2", "openflow:7:3", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		...
		if (request.getNsInstantiationLevelId().equals("il_vCDN_big")) {
			...
			nph5.add(new NetworkPathHop(0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
			nph5.add(new NetworkPathHop(1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
			nph5.add(new NetworkPathHop(2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph7.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph7.add(new NetworkPathHop(1, "openflow:7", "openflow:7:2", "openflow:7:3", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph7.add(new NetworkPathHop(2, "openflow:3", "openflow:3:2", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
