...
public class BluespaceObfnAlgorithmStatic extends AbstractNsResourceAllocationAlgorithm {

    private static final Logger log = LoggerFactory.getLogger(BluespaceObfnAlgorithmStatic.class);
     ...
     *
     */
    public BluespaceObfnAlgorithmStatic(String aitAlgorithmUrl,
