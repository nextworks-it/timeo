...
public class ComputationScaleMessage extends ComputationMessage {

	@JsonProperty("request")
	ScaleNsRequest request;

	@JsonCreator
	public ComputationScaleMessage(@JsonProperty("operationId") String operationId,
                                   @JsonProperty("request") ScaleNsRequest request) {
		this.type = ComputationMessageType.SCALE;
