 ...
 *
 */
public class DummyAlgorithm extends AbstractNsResourceAllocationAlgorithm {


	public DummyAlgorithm() {
		super(AlgorithmType.DUMMY);
	}
	...
	public NsResourceSchedulingSolution computeNsResourceAllocationSolution(InstantiateNsRequest request, Nsd nsd, Map<Vnfd, Map<String, String>> vnfds, 
		...
		VnfResourceAllocation vra1 = new VnfResourceAllocation(null, "hss", 0, "hss_vdu", 0, "OpenStack_local", "nova", "wasp");
		VnfResourceAllocation vra2 = new VnfResourceAllocation(null, "oaisim", 0, "oaisim_vdu", 0, "OpenStack_local", "nova", "wasp");
		VnfResourceAllocation vra3 = new VnfResourceAllocation(null, "mme", 0, "mme_vdu", 0, "OpenStack_local", "nova", "hulk");
		VnfResourceAllocation vra4 = new VnfResourceAllocation(null, "spgw", 0, "spgw_vdu", 0, "OpenStack_local", "nova", "hulk");
		...
		nph1.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph1.add(new NetworkPathHop(null, 1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph1.add(new NetworkPathHop(null, 2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph2.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph2.add(new NetworkPathHop(null, 1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph2.add(new NetworkPathHop(null, 2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph3.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:1", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph3.add(new NetworkPathHop(null, 1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph3.add(new NetworkPathHop(null, 2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph4.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:3", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph4.add(new NetworkPathHop(null, 1, "openflow:9", "openflow:9:4", "openflow:9:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph4.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:3", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph5.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:3", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph5.add(new NetworkPathHop(null, 1, "openflow:9", "openflow:9:4", "openflow:9:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph5.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:3", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph6.add(new NetworkPathHop(null, 0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph6.add(new NetworkPathHop(null, 1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph6.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph7.add(new NetworkPathHop(null, 0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph7.add(new NetworkPathHop(null, 1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph7.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph8.add(new NetworkPathHop(null, 0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph8.add(new NetworkPathHop(null, 1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph8.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
