...
public class DummyAlgorithm extends AbstractNsResourceAllocationAlgorithm {
	...
	public NsResourceSchedulingSolution computeNsResourceAllocationSolution(InstantiateNsRequest request, Nsd nsd, Map<Vnfd, Map<String, String>> vnfds, 
		...
		nph1.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false));
		nph1.add(new NetworkPathHop(null, 1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false));
		nph1.add(new NetworkPathHop(null, 2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true));
		...
		nph2.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false));
		nph2.add(new NetworkPathHop(null, 1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false));
		nph2.add(new NetworkPathHop(null, 2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true));
		...
		nph3.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:1", incomingLinkId, outgoingLinkId, 0, true, false));
		nph3.add(new NetworkPathHop(null, 1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false));
		nph3.add(new NetworkPathHop(null, 2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true));
		...
		nph4.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:3", incomingLinkId, outgoingLinkId, 0, true, false));
		nph4.add(new NetworkPathHop(null, 1, "openflow:9", "openflow:9:4", "openflow:9:2", incomingLinkId, outgoingLinkId, 0, false, false));
		nph4.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:3", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true));
		...
		nph5.add(new NetworkPathHop(null, 0, "openflow:1", "openflow:1:1", "openflow:1:3", incomingLinkId, outgoingLinkId, 0, true, false));
		nph5.add(new NetworkPathHop(null, 1, "openflow:9", "openflow:9:4", "openflow:9:2", incomingLinkId, outgoingLinkId, 0, false, false));
		nph5.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:3", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true));
		...
		nph6.add(new NetworkPathHop(null, 0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false));
		nph6.add(new NetworkPathHop(null, 1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false));
		nph6.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true));
		...
		nph7.add(new NetworkPathHop(null, 0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false));
		nph7.add(new NetworkPathHop(null, 1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false));
		nph7.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true));
		...
		nph8.add(new NetworkPathHop(null, 0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false));
		nph8.add(new NetworkPathHop(null, 1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false));
		nph8.add(new NetworkPathHop(null, 2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true));
