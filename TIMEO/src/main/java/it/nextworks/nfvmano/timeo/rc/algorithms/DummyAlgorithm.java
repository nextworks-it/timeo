...
public class DummyAlgorithm extends AbstractNsResourceAllocationAlgorithm {
	...
	public NsResourceSchedulingSolution computeNsResourceAllocationSolution(
		...
		nph1.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph1.add(new NetworkPathHop(1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph1.add(new NetworkPathHop(2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph2.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph2.add(new NetworkPathHop(1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph2.add(new NetworkPathHop(2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph3.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:1", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph3.add(new NetworkPathHop(1, "openflow:7", "openflow:7:2", "openflow:7:4", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph3.add(new NetworkPathHop(2, "openflow:2", "openflow:2:3", "openflow:2:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph4.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:3", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph4.add(new NetworkPathHop(1, "openflow:9", "openflow:9:4", "openflow:9:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph4.add(new NetworkPathHop(2, "openflow:3", "openflow:3:3", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph5.add(new NetworkPathHop(0, "openflow:1", "openflow:1:1", "openflow:1:3", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph5.add(new NetworkPathHop(1, "openflow:9", "openflow:9:4", "openflow:9:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph5.add(new NetworkPathHop(2, "openflow:3", "openflow:3:3", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph6.add(new NetworkPathHop(0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph6.add(new NetworkPathHop(1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph6.add(new NetworkPathHop(2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph7.add(new NetworkPathHop(0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph7.add(new NetworkPathHop(1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph7.add(new NetworkPathHop(2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
		...
		nph8.add(new NetworkPathHop(0, "openflow:2", "openflow:2:1", "openflow:2:2", incomingLinkId, outgoingLinkId, 0, true, false, null, null));
		nph8.add(new NetworkPathHop(1, "openflow:8", "openflow:8:3", "openflow:8:2", incomingLinkId, outgoingLinkId, 0, false, false, null, null));
		nph8.add(new NetworkPathHop(2, "openflow:3", "openflow:3:4", "openflow:3:1", incomingLinkId, outgoingLinkId, 0, false, true, null, null));
