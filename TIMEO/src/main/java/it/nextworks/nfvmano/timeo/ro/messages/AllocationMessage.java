...
@JsonSubTypes({
	...
	@Type(value = ScaleAllocateVnfMessage.class, 	name = "SCALE_ALLOCATE_VNF"),
	@Type(value = ScaleRemoveVnfMessage.class, 	name = "SCALE_TERMINATE_VNF"),
	@Type(value = ConfigureVnfMessage.class, 	name = "CONFIGURE_VNF"),
	@Type(value = ScaleConfigureVnfMessage.class, 	name = "SCALE_CONFIGURE_VNF"),
	...
	@Type(value = ScaleSetupUnderlyingConnectivityMessage.class, 	name = "SCALE_SETUP_UNDERLYING_CONNECTIVITY"),
